        ...
        <div className="flex flex-row gap-5 px-5 py-5">
          ...
          <span className="block basis-3/5">
            <div className="flex flex-col">
              <p className="text-base leading-relaxed text-sky-600">
                Collection name
              </p>

              <p className="text-black font-bold text-3xl mb-2 inline-block">
                {item.name}
              </p>
              <div className="flex flex-row space-x-3">
                 <p className="text-black font-normal inline-block">
                      Owner by Dung De Quy
                  </p>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="#8A939B" className="w-6 h-6 inline-block">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <p className="text-gray-400 dark:text-gray-400 font-medium">3</p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <div className="flex flex-col border-r-2">
                <div className="flex flex-row">
                  ...
                  strokeWidth={1.5} 
                  stroke="0F172A" className="w-6 h-6">
